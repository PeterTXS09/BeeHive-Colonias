    ...
    if (activeInternet == "true") {
      if (hasData) {
        ...
        if (connectivityResult) {
            ...
            await helper.checkUser(usu, contrasena).then((usuarioExiste) async {
              if (usuarioExiste["estado"] == "error") {
                ...
                bool go2 = await messageDialog(
                    Icons.error, Colors.teal, usuarioExiste["mensaje"], false,false);
                if (go2) {
            ...
            if (go) {
              ...
              if (result != null) {
                if (result["estado"] != "error") {
                  ...
                  messageDialog(
                      Icons.error, Colors.teal, result["mensaje"], false,false);
                }
              } else {
                messageDialog(Icons.error, Colors.teal,
          ...
          Navigator.of(contexto).pop();
          messageDialog(Icons.cloud_off, Colors.teal, "¡Sin conexión!", false,false);
        }
      } else {
        messageDialog(
